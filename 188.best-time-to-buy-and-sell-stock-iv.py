    ...
    def maxProfit(self, k: int, prices: List[int]) -> int:
        ...
        for price in prices:
            for i in range(1, k + 1):
                ...
                #NOTE: remember the "cost" here is not just price right now, but also the prvious profit (because if we buy stock now, previous transaction will can't be done)
